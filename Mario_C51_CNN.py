...
def run(train, Agent, env):
    ...
    update_counter = 0
    if train:
        for i in tqdm(range(1, 20_000_01)):
...
Agent.load_weights("mario_c51_20m.pt")
all_rewards, losses = run(train, Agent, env)
Agent.save_weights("mario_c51_20m.pt")

rewards_filename = '_c51_Rewards_20m.npy'
losses_filename = 'c51_Losses_20m.npy'
